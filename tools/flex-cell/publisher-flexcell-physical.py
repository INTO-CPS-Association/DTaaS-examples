...
if use_real_robots:
    ...
    kuka_filename = "/workspace/data/flex-cell/output/physical_twin/" + kuka_f_name
    ...
    filename = "/workspace/data/flex-cell/output/physical_twin/" + f_name
    ...
    if mqtt_enabled:
        ur5e_mqtt_pub = ur5e_mqtt_publisher.UR5eMQTTPublisher(filename,addr_mqtt="localhost",port_mqtt=8090,mqtt_username="username",mqtt_password="password")
...
connection = pika.BlockingConnection(pika.ConnectionParameters('localhost', 8089, credentials=credentials))
