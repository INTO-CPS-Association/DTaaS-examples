...
## Config files
kuka_conf = ConfigFactory.parse_file('/workspace/digital twins/flex-cell/kuka_actual.conf')
ur5e_conf = ConfigFactory.parse_file('/workspace/digital twins/flex-cell/ur5e_actual.conf')
...
with open('/workspace/digital twins/flex-cell/kuka_actual.conf', 'w') as f:
...
with open('/workspace/digital twins/flex-cell/ur5e_actual.conf', 'w') as f:
    print(HOCONConverter().to_hocon(ur5e_conf), file=f)
    f.close()

## modelDescription file
md_file = ET.parse('/workspace/models/flex-cell/modelDescription.xml')
...
md_file.write('/workspace/models/flex-cell/modelDescription.xml')