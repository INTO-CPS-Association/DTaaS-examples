...
if __name__ == "__main__":
    ...
    inputs = pd.read_excel(configuration_file,sheet_name="inputs",index_col="name",na_filter=False)    
    send_to_plc = pd.read_excel(configuration_file,sheet_name="send_to_plc",index_col="name",na_filter=False)  
