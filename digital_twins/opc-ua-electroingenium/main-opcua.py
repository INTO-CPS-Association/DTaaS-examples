...
if __name__ == "__main__":
    ...
    inputs = pd.read_excel(DATA['config_ods'],sheet_name="inputs",index_col="name",na_filter=False,dtype={'value':'float', 'reference':'int'})    
    send_to_plc = pd.read_excel(DATA['config_ods'],sheet_name="send_to_plc",index_col="name",na_filter=False,dtype={'value':'float', 'reference':'int'})  
    parametros = pd.read_excel(DATA['config_ods'],sheet_name="parametros",index_col="name",dtype={'value':'float', 'reference':'int'})   
